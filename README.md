...
```PHP
sudo apt-get install -y php8.1-cli php8.1-fpm php8.1-dev php8.1-pgsql php8.1-sqlite3 php8.1-imap php8.1-mysql php8.1-mbstring php8.1-xml php8.1-zip php8.1-bcmath php8.1-soap php8.1-intl php8.1-readline php8.1-common php8.1-pspell php8.1-tidy php8.1-xmlrpc php8.1-xsl php8.1-opcache php8.1-gd php8.1-mcrypt php8.1-phpdbg php8.1-redis php8.1-ldap php8.1-ds php8.1-amqp php-curl php-json php-pear php-memcached php-imagick php-apcu php-xdebug php libapache2-mod-php
```
